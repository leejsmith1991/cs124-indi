...
public class NewOrder extends JFrame implements ActionListener,
	...
	private JPanel getOrderListPane() {
		...
		final UpdatePopupMenu up = new UpdatePopupMenu(manager);
		orderList.addMouseListener(new MouseAdapter(){
			public void mouseClicked(MouseEvent me){
				if (SwingUtilities.isRightMouseButton(me) && !orderList.isSelectionEmpty() && orderList.locationToIndex(me.getPoint()) == orderList.getSelectedIndex()){
